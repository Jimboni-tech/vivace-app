...
const BottomBar = ({ onLogout }) => {
  ...
  const renderSessionBottomBar = () => (
    <View style={styles.sessionBottomBar}>
      {/* Tool Buttons */}
  ...
  // Show session bottom bar when session is active, normal bottom bar otherwise
  return isSessionActive ? renderSessionBottomBar() : renderNormalBottomBar();
};
